...
impl Default for ConsolidatedLC3 {
    fn default() -> Self {
        Self::new()
    }
}

impl LC3 for ConsolidatedLC3 {
...
pub struct CoreLC3SparseIter<'a> {
    iter: std::iter::Enumerate<<ConsolidatedLC3 as LC3>::FullIter<'a>>,
}

impl<'a> CoreLC3SparseIter<'a> {
    fn new(iter: <ConsolidatedLC3 as LC3>::FullIter<'a>) -> Self {
        Self {
            iter: iter.enumerate(),
        }
    }
